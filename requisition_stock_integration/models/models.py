...
class WorkOrder(models.Model):
    ...
    requisition_ids = fields.One2many(comodel_name="purchase.requisition", inverse_name="workorder_id",
    ...
    def create_picking(self):
        ...
        for record in self:
            ...
            if order_lines:
                ...
                location_dest = self.env.ref('requisition_stock_integration.stock_location_maintenance_cp')
    ...
    def create_requisition_by_parts(self):
        ...
        copy_record = self.env['purchase.requisition']
        for record in self:
            order_lines = []
            for rec in record.parts_ids:
